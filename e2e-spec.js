...
describe('Tutorial part 6', function () {
    ...
    function getPageElts() {
        ...
        return {
            ...
            myAnalysis: protractor_1.element(protractor_1.by.css('my-app my-analysis')),
            topHeroes: protractor_1.element.all(protractor_1.by.css('my-app my-analysis > div h4')),
